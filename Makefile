...
# xray-core now lives in-repo at protocols/xray-core (monorepo), not as a submodule.
xray-update:
	...
	$(MAKE) xray-mac
	@echo ""
	@echo "Rebase and rebuild done. Commit protocols/xray-core along with the rest of the change."
