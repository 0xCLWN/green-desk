...
( _In_z_ LPCWSTR
Name , _In_z_ LPCWSTR
TunnelType , _In_opt_ const GUID * RequestedGUID ) ;
...
_Post_maybenull_
WINTUN_ADAPTER_HANDLE(WINAPI
WINTUN_OPEN_ADAPTER_FUNC ) ( _In_z_ LPCWSTR
Name ) ;
 ...
 */
typedef VOID(WINAPI
WINTUN_CLOSE_ADAPTER_FUNC ) ( _In_opt_ WINTUN_ADAPTER_HANDLE
Adapter ) ;
 ...
 */
typedef VOID(WINAPI
WINTUN_SET_LOGGER_FUNC ) ( _In_ WINTUN_LOGGER_CALLBACK
NewLogger ) ;
...
WINTUN_START_SESSION_FUNC ) ( _In_ WINTUN_ADAPTER_HANDLE
Adapter , _In_ DWORD
Capacity ) ;
 ...
 */
typedef VOID(WINAPI
WINTUN_END_SESSION_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session ) ;
...
WINTUN_GET_READ_WAIT_EVENT_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session ) ;
...
BYTE *(WINAPI
WINTUN_RECEIVE_PACKET_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session , _Out_ DWORD * PacketSize ) ;
...
typedef VOID(
        WINAPI
WINTUN_RELEASE_RECEIVE_PACKET_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session , _In_ const BYTE * Packet ) ;
...
_Post_writable_byte_size_(PacketSize)
BYTE *(WINAPI
WINTUN_ALLOCATE_SEND_PACKET_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session , _In_ DWORD
PacketSize ) ;
 ...
 */
typedef VOID(WINAPI
WINTUN_SEND_PACKET_FUNC ) ( _In_ WINTUN_SESSION_HANDLE
Session , _In_ const BYTE * Packet ) ;
