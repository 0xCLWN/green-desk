...
const file_transport_internet_httpupgrade_config_proto_rawDesc = "" +
	...
	"'com.xray.transport.internet.httpupgradeP\x01Z:github.com/0xCLWN/xray-core/transport/internet/httpupgrade\xaa\x02#Xray.Transport.Internet.HttpUpgradeb\x06proto3"
