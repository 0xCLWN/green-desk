...
const file_transport_internet_finalmask_fragment_config_proto_rawDesc = "" +
	...
	"\n" +
	"delays_max\x18\f \x03(\x03R\tdelaysMaxB\xa2\x01\n" +
	".com.xray.transport.internet.finalmask.fragmentP\x01ZAgithub.com/0xCLWN/xray-core/transport/internet/finalmask/fragment\xaa\x02*Xray.Transport.Internet.Finalmask.Fragmentb\x06proto3"
