...
const file_transport_internet_finalmask_header_custom_config_proto_rawDesc = "" +
	...
	"\x06client\x18\x01 \x03(\v28.xray.transport.internet.finalmask.header.custom.UDPItemR\x06client\x12P\n" +
	"\x06server\x18\x02 \x03(\v28.xray.transport.internet.finalmask.header.custom.UDPItemR\x06serverB\xb1\x01\n" +
	"3com.xray.transport.internet.finalmask.header.customP\x01ZFgithub.com/0xCLWN/xray-core/transport/internet/finalmask/header/custom\xaa\x02/Xray.Transport.Internet.Finalmask.Header.Customb\x06proto3"
