...
const file_transport_internet_finalmask_xmc_config_proto_rawDesc = "" +
	...
	"\bprofiles\x18\v \x03(\v2..xray.transport.internet.finalmask.xmc.ProfileR\bprofilesJ\x04\b\x02\x10\x03B\x93\x01\n" +
	")com.xray.transport.internet.finalmask.xmcP\x01Z<github.com/0xCLWN/xray-core/transport/internet/finalmask/xmc\xaa\x02%Xray.Transport.Internet.Finalmask.XMCb\x06proto3"
