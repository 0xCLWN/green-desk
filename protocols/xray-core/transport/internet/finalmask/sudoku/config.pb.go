...
const file_transport_internet_finalmask_sudoku_config_proto_rawDesc = "" +
	...
	"paddingMax\x12#\n" +
	"\rcustom_tables\x18\a \x03(\tR\fcustomTablesB\x9c\x01\n" +
	",com.xray.transport.internet.finalmask.sudokuP\x01Z?github.com/0xCLWN/xray-core/transport/internet/finalmask/sudoku\xaa\x02(Xray.Transport.Internet.Finalmask.Sudokub\x06proto3"
