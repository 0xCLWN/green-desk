...
const file_proxy_vless_encoding_addons_proto_rawDesc = "" +
	...
	"\x04Seed\x18\x02 \x01(\fR\x04SeedBo\n" +
	"\x1dcom.xray.proxy.vless.encodingP\x01Z0github.com/0xCLWN/xray-core/proxy/vless/encoding\xaa\x02\x19Xray.Proxy.Vless.Encodingb\x06proto3"
