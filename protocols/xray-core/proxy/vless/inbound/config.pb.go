...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	...
	"\apadding\x18\a \x01(\tR\apaddingBl\n" +
	"\x1ccom.xray.proxy.vless.inboundP\x01Z/github.com/0xCLWN/xray-core/proxy/vless/inbound\xaa\x02\x18Xray.Proxy.Vless.Inboundb\x06proto3"
