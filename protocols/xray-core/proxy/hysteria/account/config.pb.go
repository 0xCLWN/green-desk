...
const file_proxy_hysteria_account_config_proto_rawDesc = "" +
	...
	"\aAccount\x12\x12\n" +
	"\x04auth\x18\x01 \x01(\tR\x04authBu\n" +
	"\x1fcom.xray.proxy.hysteria.accountP\x01Z2github.com/0xCLWN/xray-core/proxy/hysteria/account\xaa\x02\x1bXray.Proxy.Hysteria.Accountb\x06proto3"
